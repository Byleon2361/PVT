...
void
matrix_init (double a[N][N], double b[N][N], double c[N][N])
{
  srand (0);
  for (int i = 0; i < N; i++)
    {
...
void
dgemm_def (double a[N][N], double b[N][N], double c[N][N])
{
  for (int i = 0; i < N; i++)
    {
      for (int j = 0; j < N; j++)
...
void
dgemm_transpose (double a[N][N], double b[N][N], double c[N][N])
{
...
void
dgemm_interchange (double a[N][N], double b[N][N], double c[N][N])
{
  for (int i = 0; i < N; i++)
    {
      for (int k = 0; k < N; k++)
...
void
dgemm_block (double a[N][N], double b[N][N], double c[N][N])
{
...
void
dgemm_verify (double a[N][N], double b[N][N], double c[N][N], const char *msg)
{
